...
#define HOMING_FEEDRATE {35*60, 35*60, 3*60, 0}  // set the homing speeds (mm/min)

// default settings

//#define DEFAULT_AXIS_STEPS_PER_UNIT   {78.7402,78.7402,200.0*8/3,760*1.1}  // default steps per unit for ultimaker
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,775}  // default steps per unit for Ultimaker
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,824}  // default steps per unit for Ultimaker
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,800}  // default steps per unit for Nikkola
#define DEFAULT_MAX_FEEDRATE          {400, 400, 4, 35}    // (mm/sec)
...
// For the other hotends it is their distance from the extruder 0 hotend.
 #define EXTRUDER_OFFSET_X {-12.75, 12.75} // (in mm) for each extruder, offset of the hotend on the X axis
